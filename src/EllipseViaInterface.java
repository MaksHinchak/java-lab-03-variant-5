...
public final class EllipseViaInterface implements FunctionLike {
    ...
    public EllipseViaInterface(double a, double b) {
    ...
    @Override public String toString() { return "EllipseViaInterface(a=" + a + ", b=" + b + ")"; }
    ...
    @Override public boolean equals(Object other) { return other instanceof EllipseViaInterface f && Double.compare(a, f.a) == 0 && Double.compare(b, f.b) == 0; }
